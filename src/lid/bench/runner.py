...
# NOTE: the os.environ.setdefault above must run before any import below
# triggers torch initialization. Modern ruff does not flag this (a function
# call is not treated as an import barrier), so no noqa pragmas are needed.
